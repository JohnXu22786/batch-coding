...
Return your findings. Report issues with specific file+line references. Do NOT classify or prioritize them — LEAD will decide what to act on.
...
## Simplicity
- [ ] Code is as simple as the problem allows — no unnecessary abstractions
...
- Do NOT include fix suggestions — just report what's wrong
